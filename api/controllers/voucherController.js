...
const manageVoucherOfficePayment = async (voucher, oldVoucher = null, userId) => {
    try {
        ...
        // Collect all services with office assignments and prices
        ...
        // Group payments by office to create consolidated payments
        const officeGroups = {};
        ...
        // Create payments for each office
        for (const [officeName, groupData] of Object.entries(officeGroups)) {
            ...
            const notes = `Auto-generated from Voucher #${voucher.voucherNumber} - ${voucher.clientName}. Services: ${serviceDescriptions}`;
