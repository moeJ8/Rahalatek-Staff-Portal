        ...
        query = {
            ...
            $and: [
                ...
                // For custom reminders, only show sent ones (not scheduled or cancelled)
                {
                    $or: [
                        { 
                            type: { $nin: ['user_role_change', 'custom_reminder', 'attendance_checkin_reminder', 'attendance_checkout_reminder', 'monthly_financial_summary'] }
                        },
                        { 
                            type: { $in: ['attendance_checkin_reminder', 'attendance_checkout_reminder', 'monthly_financial_summary'] }, 
                            targetUser: userId 
                        },
                        { 
