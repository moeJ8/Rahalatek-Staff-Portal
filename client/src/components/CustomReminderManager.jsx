                        ...
                        <CustomScrollbar maxHeight="350px">
                            <div className="space-y-3">
                                {reminders.map((reminder) => {
                                    ...
                                    return (
                                        <div key={reminder._id} className="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
                                            <div className="flex items-center gap-3 flex-1">
                                                ...
                                                />
                                                <div className={`p-2 rounded-lg ${getStatusColor(reminder)}`}>
                                                ...
                                                <div className="flex-1">
                                                    <div className="flex items-center gap-2 mb-1">
                                                        ...
                                                        {reminder.isSystemWide ? (
                                                            ...
                                                            <span 
                                                                className="text-xs bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 px-2 py-0.5 rounded-full flex items-center gap-1 cursor-pointer hover:bg-blue-200 dark:hover:bg-blue-800/50 transition-colors"
                                                                onMouseEnter={(e) => handleUsersBadgeHover(e, reminder)}
                                                                onMouseLeave={handleUsersBadgeLeave}
                                                            >
                                                                <FaUser className="w-3 h-3" />
                                                                {reminder.targetUsers?.length || 0} User{(reminder.targetUsers?.length || 0) !== 1 ? 's' : ''}
                                                            </span>
                                                        )}
                                                    </div>
