...
export default function Footer() {
  ...
  return (
    <footer className="bg-white dark:bg-gray-800 shadow-md mt-auto transition-colors duration-300">
          ...
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8">
            <div className="flex gap-6">
              <a 
                ...
                className="text-purple-600 dark:text-purple-400 hover:text-purple-800 dark:hover:text-purple-300 text-xl"
