...
export default function VoucherForm({ onSuccess }) {
  ...
  const handleDuplicateVoucher = async () => {
    ...
    try {
      ...
      toast.success(
        "Voucher data duplicated successfully! Make changes as needed and submit to create a new voucher.",
        {
          duration: 3000,
          style: {
            background: "#4CAF50",
  ...
  const handlePreview = async () => {
    ...
    try {
      ...
      toast.error(
        "Could not get a unique voucher number. Using a default number instead.",
        {
          duration: 3000,
          style: {
            background: "#ff9800",
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        payments: {
          ...
          others: {
            ...
            price: Number(formData.payments?.others?.price) || 0,
          },
        },
        note: formData.note,
      ...
      toast.success(
        `Voucher #${generatedVoucher.voucherNumber} for ${formData.clientName} has been created successfully!`,
        {
          duration: 3000,
          style: {
            background: "#4CAF50",
        ...
        <div className="space-y-4">
          {!showPreview ? (
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        ...
                        <div>
                          ...
                          <TextInput
                            ...
                            max={
                              hotel.pax -
                              (hotel.adults !== null ? hotel.adults : 1)
                            }
                            disabled={!hotel.pax || hotel.pax < 1}
                            placeholder="Optional"
                          />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        {!formData.hotels.some((hotel) => hotel.country) &&
                          !useCustomTransferCity[index] && (
                            <p className="text-xs text-gray-500 mt-1">
                              Select hotel countries first to see available
                              cities
                            </p>
                          )}
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <div>
                          ...
                          <TextInput
                            type="number"
                            value={
                              transfer.adults !== null ? transfer.adults : ""
                            }
                            onChange={(e) => {
                              const value = e.target.value
                                ? parseInt(e.target.value)
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        ...
                        <div>
                          ...
                          <TextInput
                            ...
                            max={
                              trip.pax -
                              (trip.adults !== null ? trip.adults : 1)
                            }
                            disabled={!trip.pax || trip.pax < 1}
                            placeholder="Optional"
                          />
              ...
              <div className="mt-6 mb-6">
                <div className="mb-3">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                    Assign payment amounts to different offices for each
                    service. Total will be calculated as capital.
                  </p>
                </div>
                          ...
                          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-center">
                            <div className="space-y-1">
                              <div className="flex items-center space-x-2">
                                ...
                                <Label
                                  value={trip.tourName || "Unnamed Trip"}
                                  className="text-sm font-medium text-gray-800 dark:text-gray-200"
                                />
                              </div>
                              <p className="text-xs text-gray-500 dark:text-gray-400 pl-8 flex items-center">
                          ...
                          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-center">
                            <div className="space-y-1">
                              <div className="flex items-center space-x-2">
                                ...
                                <Label
                                  value={flight.companyName || "Unnamed Flight"}
                                  className="text-sm font-medium text-gray-800 dark:text-gray-200"
                                />
                              </div>
                              <p className="text-xs text-gray-500 dark:text-gray-400 pl-8 flex items-center">
                          ...
                          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-center">
                            <div className="space-y-1">
                              <div className="flex items-center space-x-2">
                                ...
                                <Label
                                  value={
                                    other.description || "Unnamed Other Service"
                                  }
                                  className="text-sm font-medium text-gray-800 dark:text-gray-200"
                                />
                              </div>
                            ...
                            <div>
                              <Label
                                ...
                                className="mb-2 block text-xs font-medium text-gray-600 dark:text-gray-400"
                              />
                              <div className="flex rounded-lg overflow-hidden border border-gray-300 dark:border-slate-600 focus-within:ring-2 focus-within:ring-pink-500 dark:focus-within:ring-pink-400">
                                <TextInput
                                  type="number"
                                  value={other.price || 0}
                                  onChange={(e) =>
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-600">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          Capital is calculated automatically and cannot be
                          edited manually
                        </p>
                      </div>
            ...
            <div>
              ...
              <VoucherPreview
                voucherData={
                  generatedVoucher || { ...formData, voucherNumber: 10000 }
                }
                onSave={handleSubmit}
                saveButton={
                  <CustomButton
            ...
            <div className="space-y-6">
              {duplicateModalLoading ? (
                ...
                <div className="text-center text-gray-500">
                  No vouchers available to duplicate. Please create a voucher
                  first.
                </div>
              )}
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                ...
                <CustomButton
                  ...
                  disabled={
                    !selectedVoucherToDuplicate || duplicateModalLoading
                  }
                  icon={HiDuplicate}
                >
                  Duplicate
