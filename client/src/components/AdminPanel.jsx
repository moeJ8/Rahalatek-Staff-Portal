            ...
            {loading ? (
                ...
                <div className="w-full">
                    ...
                    <div className="flex flex-col md:flex-row w-full">
                        {/* Sidebar for desktop */}
                        <div className="hidden md:block w-64 bg-white dark:bg-gray-800 shadow-lg rounded-lg mr-4 h-fit sticky top-4">
                            ...
                            <nav className="p-2" role="tablist" aria-label="Admin Sections">
                                <button
                                    ...
                                    className={`flex items-center w-full px-4 py-3 mb-2 text-left rounded-lg transition-colors ${
                                        activeTab === 'hotels' 
                                            ? 'bg-purple-50 text-purple-700 font-medium dark:bg-gray-700 dark:text-purple-400' 
                            ...
                            <div className="md:hidden border-b border-gray-200 dark:border-gray-700 mb-4">
                                <div className="flex flex-wrap justify-center gap-1" role="tablist" aria-label="Admin Sections">
                                    ...
                                    <button
                                        ...
                                        className={`relative py-2 px-3 text-sm sm:text-base sm:px-4 ${activeTab === 'requests' ? 'border-b-2 border-purple-600 font-medium text-purple-600 dark:text-purple-400 dark:border-purple-400' : 'text-gray-500 hover:text-gray-700 dark:text-gray-300 dark:hover:text-gray-100'}`}
                                        onClick={() => handleTabChange('requests')}
                                        onKeyDown={(e) => handleTabKeyDown(e, 'requests')}
                                        tabIndex={0}
                                        role="tab"
                                        ...
                                        <div className="overflow-x-auto">
                                            <Table>
                                                <Table.Head>
                                                    ...
                                                    <Table.HeadCell className="text-center">Admin Status</Table.HeadCell>
