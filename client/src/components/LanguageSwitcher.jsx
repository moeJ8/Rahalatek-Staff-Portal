...
export default function LanguageSwitcher({ variant = "default" }) {
  ...
  const languages = allLanguages.filter((lang) =>
    visibleLanguages.includes(lang.code)
  );

  const currentLangData = allLanguages.find(
    ...
    <div className="relative" ref={dropdownRef}>
      ...
      {!isMobile && (
        <div
          ...
          } mt-3 w-40 rounded-2xl shadow-2xl overflow-hidden z-50 transition-all duration-200 ease-in-out origin-top ${
            isOpen
